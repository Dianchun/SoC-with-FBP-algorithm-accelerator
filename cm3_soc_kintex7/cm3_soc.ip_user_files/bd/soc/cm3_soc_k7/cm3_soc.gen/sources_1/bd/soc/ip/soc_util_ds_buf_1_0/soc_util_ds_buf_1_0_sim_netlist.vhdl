...
-- Date        : Tue Apr 14 22:46:25 2020
-- Host        : DESKTOP-L1H3OJ0 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top soc_util_ds_buf_1_0 -prefix
--               soc_util_ds_buf_1_0_ soc_util_ds_buf_1_0_sim_netlist.vhdl
-- Design      : soc_util_ds_buf_1_0
...
entity soc_util_ds_buf_1_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of soc_util_ds_buf_1_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of soc_util_ds_buf_1_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of soc_util_ds_buf_1_0_util_ds_buf : entity is "ibufdsgte2";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of soc_util_ds_buf_1_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of soc_util_ds_buf_1_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of soc_util_ds_buf_1_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of soc_util_ds_buf_1_0_util_ds_buf : entity is 1;
end soc_util_ds_buf_1_0_util_ds_buf;

architecture STRUCTURE of soc_util_ds_buf_1_0_util_ds_buf is
...
entity soc_util_ds_buf_1_0 is
  ...
  attribute NotValidForBitStream of soc_util_ds_buf_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of soc_util_ds_buf_1_0 : entity is "soc_util_ds_buf_1_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of soc_util_ds_buf_1_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of soc_util_ds_buf_1_0 : entity is "util_ds_buf,Vivado 2020.2";
end soc_util_ds_buf_1_0;

architecture STRUCTURE of soc_util_ds_buf_1_0 is
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN soc_util_ds_buf_1_0_IBUF_DS_ODIV2, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN soc_util_ds_buf_1_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.soc_util_ds_buf_1_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
