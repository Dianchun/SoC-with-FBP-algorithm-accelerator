...
#
# Generated by export_simulation on Wed Apr 15 11:26:11 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './blk_mem_32bit.sh' script.

./blk_mem_32bit.sh -reset_run
...
./blk_mem_32bit.sh -noclean_files

For more information on the script, please type './blk_mem_32bit.sh -help'.
