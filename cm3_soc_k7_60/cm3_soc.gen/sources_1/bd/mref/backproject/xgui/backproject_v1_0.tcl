...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "IMG_N" -parent ${Page_0}
  ipgui::add_param $IPINST -name "PIPELINES_NUM" -parent ${Page_0}
...
proc update_PARAM_VALUE.IMG_N { PARAM_VALUE.IMG_N } {
	# Procedure called to update IMG_N when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.IMG_N { PARAM_VALUE.IMG_N } {
	# Procedure called to validate IMG_N
	return true
}

proc update_PARAM_VALUE.PIPELINES_NUM { PARAM_VALUE.PIPELINES_NUM } {
	# Procedure called to update PIPELINES_NUM when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PIPELINES_NUM { PARAM_VALUE.PIPELINES_NUM } {
	# Procedure called to validate PIPELINES_NUM
	return true
}
...
proc update_MODELPARAM_VALUE.IMG_N { MODELPARAM_VALUE.IMG_N PARAM_VALUE.IMG_N } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.IMG_N}] ${MODELPARAM_VALUE.IMG_N}
}
...
proc update_MODELPARAM_VALUE.PIPELINES_NUM { MODELPARAM_VALUE.PIPELINES_NUM PARAM_VALUE.PIPELINES_NUM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PIPELINES_NUM}] ${MODELPARAM_VALUE.PIPELINES_NUM}
}
