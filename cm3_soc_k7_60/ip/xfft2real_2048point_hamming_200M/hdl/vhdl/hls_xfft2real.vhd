...
architecture behav of hls_xfft2real is 
    ...
    "hls_xfft2real_hls_xfft2real,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k325t-ffg676-2,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.283750,HLS_SYN_LAT=3092,HLS_SYN_TPT=3093,HLS_SYN_MEM=18,HLS_SYN_DSP=0,HLS_SYN_FF=4419,HLS_SYN_LUT=3891,HLS_VERSION=2020_2}";
